...
Examples:
	...
	| previousAY-05-01 | previousAY-09-01 | N/A              | approved       | the short course learner is not returned in the earnings response                | # Get short course learners (continuing, planned for last year) for academic year
	...
	| previousAY-05-01 | previousAY-09-01 | currentAY-09-01  | approved       | only completion short course earning is returned in the earnings response        | # Get short course learners (completed this year, planned for last year) for academic year
	| previousAY-05-01 | currentAY-09-01  | currentAY-09-01  | approved       | only completion short course earning is returned in the earnings response        | # Get short course learners (spanning both years and completed this year) for academic year
	| previousAY-05-01 | currentAY-09-01  | N/A              | approved       | only completion short course earning is returned in the earnings response        | # Get short course learners (spanning both years and continuing) for academic year
	...
	| previousAY-05-01 | previousAY-09-01 | N/A              | not approved   | the short course learner is not returned in the earnings response                | # Get short course learners (continuing, planned for last year) for academic year (not approved)
	...
	| previousAY-05-01 | previousAY-09-01 | currentAY-09-01  | not approved   | only completion short course earning is returned in the earnings response        | # Get short course learners (completed this year, planned for last year) for academic year (not approved)
	| previousAY-05-01 | currentAY-09-01  | currentAY-09-01  | not approved   | only completion short course earning is returned in the earnings response        | # Get short course learners (spanning both years and completed this year) for academic year (not approved)
	| previousAY-05-01 | currentAY-09-01  | N/A              | not approved   | only completion short course earning is returned in the earnings response        | # Get short course learners (spanning both years and continuing) for academic year (not approved)
	| currentAY-07-01  | nextAY-08-31     | N/A              | not approved   | only 30% short course earning is returned in the earnings response               | # Get short course learners with only 30% earnings
