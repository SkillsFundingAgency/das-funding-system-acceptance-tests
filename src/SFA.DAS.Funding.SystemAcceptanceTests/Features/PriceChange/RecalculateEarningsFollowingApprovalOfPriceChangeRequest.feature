...
Examples:
	...
	| currentAY-08-25 | nextAY-04-25 |        15000 |             2 | currentAY-12-01 |           18000 |            1200 | currentAY            |             600 |               5 |
	| currentAY-08-26 | nextAY-04-26 |        15000 |             1 | currentAY-08-27 |            8000 |            -100 | currentAY            |             600 |               1 |
...
Examples:
	...
	| currentAY-07-23 | nextAY-03-23    |        15000 |             2 | currentAY-07-23 |           18000 |          18000 | null |             750 | currentAY            |              12 |
	| currentAY-07-23 | nextAY-03-23    |        15000 |             2 | null            |               0 | null           | null |             750 | currentAY            |              12 |
	| currentAY-08-01 | currentAY-07-31 |        15000 |             2 | null            |           18000 |          15000 | 3000 |            1200 | currentAY            |               1 |
...
Examples:
	| start_date       | end_date         | agreed_price | training_code | pc_from_date     | new_total_price | training_price | epao | new_inst_amount | academic_year_string | delivery_period |
	| currentAY-08-01 | currentAY-07-31 |        15000 |             2 | null             |           15000 |          15000 | null |            1000 | currentAY           |               1 |
