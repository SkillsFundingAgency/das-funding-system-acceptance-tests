...
Background: 
	...
	And learning support earnings are generated from periods nextAY-R01 to nextAY-R04

#FLP-1421 - AC1
@regression
Scenario: Training provider records a return from E&M break in learning
	Given SLD record a return from break in learning for English and Maths course with new start date nextAY-01-15
	And SLD submit updated learners details
	...
	And Maths and English earnings are generated from periods nextAY-R06 to nextAY-R08 with instalment amount 133.33000 for course English Foundation
...
Scenario: Training provider corrects a return from E&M break in learning 
	...
	And Maths and English earnings are generated from periods nextAY-R06 to nextAY-R08 with instalment amount 133.33000 for course English Foundation
	When SLD inform us of a correction to an English and Maths return from break in learning with new start date nextAY-02-05
	And SLD submit updated learners details
	Then Maths and English earnings are generated from periods nextAY-R01 to nextAY-R04 with regular instalment amount 100 for course English Foundation
	And Maths and English earnings are generated from periods nextAY-R07 to nextAY-R08 with instalment amount 200 for course English Foundation
