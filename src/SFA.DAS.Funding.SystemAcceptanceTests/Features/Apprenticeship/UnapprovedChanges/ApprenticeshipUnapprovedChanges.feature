...
Scenario: Calculate unapproved apprenticeship earnings
	Given SLD inform us of a learner with apprenticeship, english and maths, incentives and learning support having start date nextAY-08-01, expected end date currentAy-07-31, standard code 615 and agreed price 15000
	...
	And Maths and English earnings are generated from periods nextAY-R01 to currentAy-R12 with regular instalment amount 83.33 for course English Foundation
	...
	And learning support earnings are generated from periods nextAY-R01 to currentAy-R12
