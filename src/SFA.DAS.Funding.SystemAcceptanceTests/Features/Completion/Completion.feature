...
Scenario: Balancing and Completion earnings on Completion
	...
	Then a Balancing earning of <expected_balancing_amount> is generated for period <expected_balancing_period>
	And a Completion earning of <expected_completion_amount> is generated for period <expected_completion_period>
